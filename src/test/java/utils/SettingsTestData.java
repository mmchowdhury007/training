...
public class SettingsTestData {
    ...
    private final String TEST_DATA_1 = TEST_DATA_PATH + "testData1.json";
    private final String TEST_DATA_2 = TEST_DATA_PATH + "testData1.json";
    ...
    public TestData1 getTestData1(){
        return deserializeJson(TEST_DATA_1, TestData1.class);
    }

    public TestData2 getTestData2() {
        return deserializeJson(TEST_DATA_2, TestData2.class);
    }
